    ...
    <section class="bg-light w-100">
        <div class="container">
            <div class="row d-flex align-items-center py-5">
                ...
                <div class="col-lg-6">
                    <img src="{{asset('landing/assets/img/animasi_kurban 1.png')}}">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-3 col-12 align-left">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="text-light h5">PurpleMenabung</span> <span class="text-light h5 semi-bold-600">BuzzMenabung</span>
                    </a>
